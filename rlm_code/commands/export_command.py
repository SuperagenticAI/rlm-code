...
def _export_as_json(
    ...
    export_data = {
        "export_info": {
            "format": "rlm-code-json",
            "version": "1.0",
            "exported_at": datetime.now().isoformat(),
            "exported_by": "rlm-code",
        },
        "component": {
...
This package contains a DSPy component exported from RLM Code.
...
This component was created using RLM Code, a command-line interface for the DSPy framework.

- Learn more: https://github.com/SuperagenticAI/rlm-code
...
def _show_sharing_instructions(output_file: Path, export_format: str) -> None:
    ...
    if export_format == "json":
        ...
        console.print("   [cyan]rlm-code import component.json[/cyan]")
    else:
