...
def _show_welcome_message() -> None:
    ...
    welcome_text = """
[bold]Welcome to RLM Code Interactive Component Creator![/bold]
...
"""
    ...
    console.print(Panel(welcome_text, title="RLM Code Create", border_style="blue"))
...
def _show_next_steps(output_file: Path) -> None:
    ...
    console.print(f"   [cyan]rlm-code run {output_file} --interactive[/cyan]")
    console.print("\n2. Optimize performance:")
    console.print(f"   [cyan]rlm-code optimize {output_file}[/cyan]")
    console.print("\n3. Export for sharing:")
    console.print(f"   [cyan]rlm-code export {output_file}[/cyan]")
