"""
Natural Language Command Router for RLM Code.
...
class NLCommandRouter:
    ...
    def _route_with_llm(
        ...
        try:
            ...
            prompt = f"""You are an intelligent command router for RLM Code CLI. Your job is to understand the user's intent and route them to the correct command with the right arguments.
