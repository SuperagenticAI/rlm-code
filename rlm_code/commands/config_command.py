...
def reset_config(skip_confirmation: bool = False, verbose: bool = False) -> None:
    ...
    try:
        ...
        console.print(
            "   Edit rlm_config.yaml (legacy: dspy_config.yaml) or run '/connect <provider> <model>' in interactive mode"
        )
        console.print("\n2. View configuration:")
        console.print("   [cyan]rlm-code config show[/cyan] (legacy: rlm-code config show)")
