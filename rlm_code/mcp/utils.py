...
def format_mcp_error_message(
    operation: str, server_name: str, error: Exception, include_troubleshooting: bool = True
) -> str:
    """
    ...
    if include_troubleshooting:
        ...
        if "not found" in error_str:
            tips.append(
                "Server not found. Check the server configuration in rlm_config.yaml (legacy: dspy_config.yaml)"
            )
