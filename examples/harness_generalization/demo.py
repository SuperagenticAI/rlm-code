#!/usr/bin/env python3
"""Offline proof of locally in-distribution harness generalization in RLM Code."""
...
def run_demo() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="rlm-harness-generalization-") as temp_dir:
