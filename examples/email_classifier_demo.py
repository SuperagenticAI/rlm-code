...
# PART 5: OPTIMIZATION
# ============================================================================
# In CLI: "rlm-code optimize email_classifier.py"
...
def demo_classifier():
    ...
    # In the CLI, you'd do: run `rlm-code` and then `/connect ollama llama3.1:8b`
...
if __name__ == "__main__":
    print()
    print("This example shows what you can build with RLM Code!")
    print()
