...
Common questions about RLM Code, answered!

## General Questions

### What is RLM Code?

RLM Code is an interactive development environment for DSPy. It helps you create, validate, and optimize DSPy programs through a simple command-line interface with natural language support.

### Do I need to know DSPy to use RLM Code?

No! RLM Code is perfect for beginners. You can:
...
Yes! RLM Code is open source and completely free to use.

### What DSPy versions are supported?

RLM Code works with ANY DSPy version (2.x, 3.x, or newer). It adapts to your installed version automatically!

## Installation & Setup

### How do I install RLM Code?
...
Yes, RLM Code requires DSPy to be installed:

```bash
pip install dspy
```

### Can I use RLM Code without installing provider SDKs?

Yes! Provider SDKs (openai, anthropic, etc.) are optional. RLM Code will tell you if you need one and how to install it.

### Why does indexing fail with permission errors?

This can happen if your Python packages are in restricted directories. Don't worry! RLM Code still works. You just won't be able to ask questions about DSPy internals.

## Using RLM Code

### How do I start RLM Code?
...
### Can I use RLM Code offline?

Yes! RLM Code works offline using templates. For better results, connect to a model:
...
### What can RLM Code generate?

RLM Code can generate:
...
Yes! The generated code is yours to modify. RLM Code gives you a starting point, and you can customize it however you like.
...
Yes! RLM Code uses templates when no model is connected. The code will be more generic but still functional.
...
**Real!** RLM Code uses actual `dspy.teleprompt.GEPA` from your installed DSPy version. No mocking or simulation.

### Do I need training data for optimization?

Yes. You can:

- Generate it with RLM Code
- Provide your own
...
This is okay! RLM Code will skip what it can't access and still work normally.

## Advanced Questions

### Can I use RLM Code in CI/CD?

Yes! RLM Code works in automated environments. See the [CI/CD Guide](../advanced/cicd.md).

### Can I use RLM Code in Docker?

Yes! See the [Deployment Guide](../advanced/deployment.md) for Docker examples.

### Can I integrate MCP servers?

Yes! RLM Code has full MCP support. See the [MCP Integration Guide](../advanced/mcp-integration.md).
...
- Report issues on [GitHub Issues](https://github.com/superagentic-ai/rlm-code/issues)

### How do I report a bug?

Open an issue on [GitHub](https://github.com/superagentic-ai/rlm-code/issues) with:
...
Open a feature request on [GitHub](https://github.com/superagentic-ai/rlm-code/issues) describing:
...
- [GitHub Issues](https://github.com/superagentic-ai/rlm-code/issues)

---

**Didn't find your answer?** [Open an issue](https://github.com/superagentic-ai/rlm-code/issues) for technical support.
