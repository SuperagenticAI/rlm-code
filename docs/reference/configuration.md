...
Complete reference for RLM Code configuration files and settings.

---

## Configuration File

RLM Code uses `dspy_config.yaml` in your project root for configuration.
...
If RLM Code can't find your config:
