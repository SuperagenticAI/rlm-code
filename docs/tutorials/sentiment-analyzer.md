...
In this tutorial, you'll build a complete sentiment analysis system using RLM Code. Perfect for beginners!
...
- RLM Code installed ([Installation Guide](../getting-started/installation.md))
- Basic understanding of Python
- (Optional) Ollama or OpenAI API key for better results

## Step 1: Start RLM Code
...
!!! info "Without a Model?"
    No problem! RLM Code can still generate code using templates. The code will be more generic but still functional.
...
RLM Code will generate complete code for you!
...
RLM Code will execute your code in a safe sandbox and show the results.
...
RLM Code will create training examples for you!
...
Exit RLM Code and run the optimization:
...
- ✅ How to use RLM Code interactively
...
**Questions?** Check the [FAQ](../reference/faq.md), [Troubleshooting Guide](../reference/troubleshooting.md), or [open an issue](https://github.com/superagentic-ai/rlm-code/issues).
