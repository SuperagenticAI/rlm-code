  ...
  <div class="hero-content">
    <div class="hero-top">
      <div style="text-align: center; margin-bottom: 2em;">
        <img src="resource/rlm-code.png" alt="RLM Code Logo" style="width: 140px; margin-bottom: 1em;">
        <br/>
        <img src="resource/rlm-code-banner.png" alt="RLM Code Banner" style="width: 600px; max-width: 90%; margin: 0 auto 1em;">
        <br/>
        <img src="resource/rlm-code-text.svg" alt="RLM Code" style="width: 400px; max-width: 80%; margin: 0 auto;">
      </div>
...
<div style="background: rgba(147, 51, 234, 0.1); border-left: 4px solid #9333ea; padding: 1em 1.5em; margin: 2em 0; border-radius: 8px; font-size: 0.95em; line-height: 1.6;">
  <p style="margin: 0; color: var(--md-default-fg-color--light);">
    <strong style="color: var(--md-default-fg-color);">💡 Note:</strong> RLM Code is in its <strong>initial release</strong> and under <strong>active development</strong>.
    The quality and effectiveness of generated code depends on several factors: the <strong>language model</strong> you connect,
    <strong>MCP (Model Context Protocol) servers</strong> you integrate, and the <strong>context</strong> you provide to RLM Code.
...
## 🚀 Use Cases: When to Use RLM Code
...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 1.5em; border-radius: 10px; color: white;">
  ...
  <pre style="background: rgba(0,0,0,0.2); padding: 1em; border-radius: 5px; margin: 0;"><code>pip install rlm-code</code></pre>
</div>
...
<div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 1.5em; border-radius: 10px; color: white;">
  ...
  <pre style="background: rgba(0,0,0,0.2); padding: 1em; border-radius: 5px; margin: 0;"><code>rlm-code</code></pre>
</div>
...
```
Week 1:
→ rlm-code /init in existing project
...
!!! question "Do I need to know DSPy first?"
    **No!** That's the whole point. RLM Code teaches you as you build. Just start creating and ask questions when you need help.

!!! question "Can I use this with my existing DSPy code?"
    **Yes!** Run `/init` in your project directory. RLM Code will scan your code and help you extend it.
...
!!! question "Do I need to read documentation?"
    **No!** Just ask RLM Code. It answers questions using your actual installed DSPy version.
...
- **[GitHub Issues](https://github.com/superagentic-ai/rlm-code/issues)** - Report bugs or request features
...
<div style="text-align: center; margin: 3em 0; padding: 2em; background: rgba(124, 58, 237, 0.05); border-radius: 10px;">
  <p style="font-size: 1.1em; color: #6b7280; margin: 0;">
    <strong style="color: #7c3aed;">RLM Code</strong> by
  ...
  <p style="color: #9ca3af; margin-top: 0.5em;">
    Comprehensive CLI to Optimize Your RLM Code - Learn by building. No docs required.
  </p>
</div>
