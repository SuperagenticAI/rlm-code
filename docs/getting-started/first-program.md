...
!!! info "Without a Model?"
    You can still use RLM Code with templates. The code will be more generic but functional.
...
RLM Code will generate complete code!
...
RLM Code executes your code safely and shows results.
