...
Learn how RLM Code works and how it helps you build better DSPy programs.

## What is RLM Code?

RLM Code is an **interactive development environment** for DSPy that:
...
RLM Code is a "living playbook" that:
...
RLM Code shows your DSPy version on startup:
...
RLM Code analyzes your request:
...
> Anthropic no longer offers free API keys. If you have a paid key, RLM Code will work with Claude; otherwise, just skip Anthropic and use another provider.
