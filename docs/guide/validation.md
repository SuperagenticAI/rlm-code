...
Learn how RLM Code validates your code for quality, correctness, and best practices.

## What is Validation?

RLM Code's validation engine checks your DSPy code for:
...
RLM Code can suggest fixes for common issues:
...
RLM Code applies suggested fixes automatically!
...
Create `.rlm-code/validation-rules.yaml`:
