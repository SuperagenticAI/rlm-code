...
RLM Code supports **natural language for evaluation**! You don't need to remember command syntax - just describe what you want:
...
RLM Code automatically understands your intent and routes to the appropriate evaluation command. See the [Natural Language Commands](../guide/natural-language-commands.md) guide for more examples.
...
RLM Code supports a comprehensive set of evaluation metrics:
...
RLM Code generates comprehensive evaluation reports:
