...
Learn how to integrate Model Context Protocol (MCP) servers with RLM Code for extended capabilities.
...
**In RLM Code**, MCP enables your DSPy programs to:
...
RLM Code establishes connection and discovers available tools.
...
RLM Code generates code with MCP integration!
...
[See MCP Examples →](https://github.com/superagentic-ai/rlm-code/tree/main/examples){ .md-button .md-button--primary }
