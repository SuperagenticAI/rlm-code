"""
Export and import handler for RLM Code.
...
class ExportImportHandler:
    ...
    def __init__(self, config_manager=None):
        ...
        primary_export_dir = Path.cwd() / ".rlm__code" / "exports"
        legacy_export_dirs = [
            Path.cwd() / ".rlm_code" / "exports",
            Path.cwd() / ".dspy_code" / "exports",
        ]
        self.export_dir = primary_export_dir
        if not primary_export_dir.exists():
            for candidate in legacy_export_dirs:
                if candidate.exists():
    ...
    def export_session_bundle(
        ...
        try:
            ...
            readme.write_text(f"""# RLM Code Session Bundle
