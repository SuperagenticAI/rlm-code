"""
Welcome screen and branding for RLM Code.
"""
...
# ASCII Art for RLM Code (bold, dotted style)
RLM_ASCII_ART = """
   ██████╗ ███████╗██████╗ ██╗   ██╗     ██████╗ ██████╗ ██████╗ ███████╗
   ██╔══██╗██╔════╝██╔══██╗╚██╗ ██╔╝    ██╔════╝██╔═══██╗██╔══██╗██╔════╝
   ██║  ██║███████╗██████╔╝ ╚████╔╝     ██║     ██║   ██║██║  ██║█████╗
...
def show_welcome_screen(model_name: str = "Not configured"):
    ...
    ascii_text = create_gradient_text(RLM_ASCII_ART, gradient_colors)
    ascii_panel = Panel(
    ...
    welcome_text.append("M", style="bright_magenta")
    welcome_text.append(" ", style="white")
    welcome_text.append("C", style="bright_red")
    welcome_text.append("o", style="bright_yellow")
    welcome_text.append("d", style="bright_green")
    welcome_text.append("e", style="bright_cyan")
    welcome_text.append(" - Your AI-Powered Agent Development Assistant: ", style="white")
    ...
    welcome_text.append("r", style="bright_cyan")
    welcome_text.append(" ", style="white")
    welcome_text.append("R", style="bright_blue")
    welcome_text.append("L", style="bright_magenta")
    welcome_text.append("M", style="bright_red")
    welcome_text.append(" ✨", style="bright_yellow")
...
[green]•[/green] Multi-framework guidance
...
"""
    ...
    ready_text.append("Ready to build amazing agent systems? ", style="bold white")
...
def show_compact_header():
    ...
    header = Text()
    header.append("RLM Code", style="bold cyan")
