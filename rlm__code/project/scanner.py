...
class ProjectScanner:
    ...
    def scan_directory(self, path: str = ".") -> ProjectState:
        ...
        primary_config = path / ConfigManager.CONFIG_FILENAME
        legacy_config = path / ConfigManager.LEGACY_CONFIG_FILENAME
        has_config = primary_config.exists() or legacy_config.exists()
